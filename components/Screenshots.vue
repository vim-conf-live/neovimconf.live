                ...
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="section-title text-center">
                        ...
                        <p>
                            ...
                            <br />
                            vim community are coming to share their experience and expertise with
                            the community.
                        </p>
                    </div>
            ...
            <div v-if="showslide" class="app-shot-one__carousel thm__owl-carousel">
                <swiper :options="swiperOptions">
                    <swiper-slide>
                        <!-- slingle app image -->
                        <div class="item">
                            <img src="/assets/img/speaker-bryan.png" alt="" />
                        </div>
                        <!-- slingle app image -->
                    </swiper-slide>
                    ...
                    <swiper-slide>
                        <!-- slingle app image -->
                        <div class="item">
                            <img src="/assets/img/speaker-primeagen.png" alt="" />
                        </div>
                        <!-- slingle app image -->
                    </swiper-slide>
                    ...
                    <swiper-slide>
                        <!-- slingle app image -->
                        <div class="item">
                            <img src="/assets/img/speaker-thomas.png" alt="" />
                        </div>
                        <!-- slingle app image -->
                    </swiper-slide>
                    ...
                    <swiper-slide>
                        <!-- slingle app image -->
                        <div class="item">
                            <img src="/assets/img/speaker-leeren.png" alt="" />
                        </div>
                        <!-- slingle app image -->
                    </swiper-slide>
                    <swiper-slide>
                        <!-- slingle app image -->
                        <div class="item">
                            <img src="/assets/img/speaker-nikola.png" alt="" />
                        </div>
                        <!-- slingle app image -->
                    </swiper-slide>
                </swiper>
