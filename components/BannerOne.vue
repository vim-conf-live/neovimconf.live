            ...
            <div class="row align-items-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="banner-text-inner">
                        ...
                        <h1>Come join the worlds first virtual vim conf!</h1>
                        <p>We're bringing together Vimmers from all around the world to connect and
                        share their love and passion for all things vim!</p>
