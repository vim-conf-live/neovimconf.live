    ...
    <form @submit.prevent @submit="register">
      <div class="grid grid-cols-12 mt-6 gap-1">
        <div class="col-span-7 md:col-span-4">
          <label
            for="email"
            class="text-sm font-bold mb-2 px-0 text-base text-gray-200"
          >
            Email Address
          </label>
          <input
            ...
            class="rounded shadow h-12 w-full text-orange-600"
            @focus="showDisclaimer()"
          />
          <transition name="fade">
            <div
              v-show="shouldShowDisclaimer"
              class="block text-gray-200 text-sm italic"
            >
        ...
        <div class="pt-6 col-span-5 md:col-span-3">
          <button
            ...
            class="
              ...
              disabled:bg-orange-600 disabled:opacity-50
            "
          >
        ...
        <div class="pt-6 col-span-12 md:col-span-5 md:pl-6">
          ...
          >
            ...
            <img
              class="inline-block w-5 h-5 ml-2 mt-0"
...
export default {
  ...
  methods: {
    ...
    isValid() {
      return this.email && this.$refs.email && this.$refs.email.checkValidity()
    },
    async register() {
