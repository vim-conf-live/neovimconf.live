defmodule Nvc.Accounts do
  ...
  alias Nvc.Accounts.{User, UserToken, UserNotifier}
  ...
  """
  def deliver_magic_link(user, magic_link_url_fn) do
    {email_token, token} = UserToken.build_email_token(user, "magic_link")
    Repo.insert!(token)

    UserNotifier.deliver_magic_link(user, magic_link_url_fn.(email_token))
  end
